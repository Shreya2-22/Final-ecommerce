            ...
            <table class="table table-bordered table-hover align-middle">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="../pages/traderproductdetailform.php?product_id=<?= urlencode($product['product_id']) ?>" class="btn btn-sm btn-outline-primary me-1">View</a>
                    <a href="../pages/traderupdateproductform.php?product_id=<?= urlencode($product['product_id']) ?>" class="btn btn-sm btn-outline-warning me-1">Edit</a>
