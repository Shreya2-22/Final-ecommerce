...
<head>
  ...
  if (isset($_POST['btnSubmit'])) {
    ...
    if ($error == 0) {
      ...
      $query = "INSERT INTO user_master(Name, Email, DOB, Phone, Username, Password,Shop_Name, Shop_Type, Shop_Image, Role, Status) VALUES ('$name', '$email', '$dob', '$phone', '$username', '$password','$shop_name' '$type', '$image', '$role', '$status')";
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-2">
          ...
          <div class="mb-2">
            ...
            <input type="date" name="Trad_Dob" class="form-control" placeholder="Date of Birth" value="<?php if (isset($dob)) echo $dob ?>">
          ...
          <div class="mb-2">
            ...
            <div class="mb-2">
              ...
              <input type="password" name="Trad_Password" class="form-control" placeholder="Password" value="">
              <?php if (isset($error_password)) echo '<div class="error">' . $error_password . '</div>'; ?>
            </div>

            <div class="mb-2">
              <label class="form-label">Confirm Password </label>
              <input type="password" name="Trad_Confirm_Password" class="form-control" placeholder="Confirm Password" value="">
            ...
            <div class="mb-2">
              ...
              <input type="text" name="Shop_name" class="form-control" plcaholder="Enter shop name" value="<?php if (isset($shop_name)) echo $shop_name ?>">
              <?php if (isset($error_shop_name)) echo '<div class="error">' . $error_shop_name . '</div>'; ?>
            </div>

            <div class="mb-3">
              <label class="form-label">Shop Type</label>
              <select name="Shop_Type" class="form-select" value="<?php if (isset($type)) echo $type ?>">
            ...
            <div class="mb-2">
              ...
              <input type="file" name="Trad_Image" class="form-control" value="<?php if(isset($image)) echo $image ?>" accept="image/*">
            ...
            <div class="d-grid mb-3">
              <button type="btnSubmit" class="btn text-white" style="background-color: #C49A6C;">SIGN UP</button>
            </div>
