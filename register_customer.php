		...
		<div class="register-box">
			...
			<form action="" method="POST" enctype="multipart/form-data">
				<div class="mb-2">
					...
					<input type="text" name="Cname" class="form-control" placeholder="Enter your full name" value="<?php if (isset($name)) echo $name ?>">
				...
				<div class="mb-2">
					...
					<input type="email" name="CEmail" class="form-control" placeholder="Xyz@gmail.com" value="<?php if (isset($email)) echo $email ?>">
				...
				<div class="mb-2">
					...
					<input type="date" name="Cdob" class="form-control" placeholder="Date of Birth" value="<?php if (isset($dob)) echo $dob ?>">

					<?php if (isset($error_dob)) echo '<div class="error">' . $error_dob . '</div>'; ?>
				...
				<div class="mb-2">
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="CGender" id="genderMale" value="Male" <?php if (isset($gender) && $gender == "Male") echo "checked" ?>>
						<label class="form-check-label" for="genderMale">Male</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="CGender" id="genderFemale" value="Female" <?php if (isset($gender) && $gender == "Female") echo "checked" ?>>
						<label class="form-check-label" for="genderFemale">Female</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="CGender" id="genderOther" value="Other" <?php if (isset($gender) && $gender == "Other") echo "checked" ?>>
				...
				<div class="mb-2">
					...
					<input type="tel" name="CPhone" class="form-control" placeholder="+977 98xxxxxxx" value="<?php if (isset($phone)) echo $phone ?>">
					<?php if (isset($error_phone)) echo '<div class="error">' . $error_phone . '</div>'; ?>
				</div>

				<div class="mb-2">
					<label class="form-label">Username </label>
					<input type="text" name="CUsername" class="form-control" placeholder="Username" value="<?php if (isset($username)) echo $username ?>">
				...
				<div class="mb-2">
					...
					<input type="password" name="CPass" class="form-control" placeholder="Password" value="">
				...
				<div class="mb-2">
					...
					<input type="password" name="CPassCon" class="form-control" placeholder="Confirm Password" value="">
